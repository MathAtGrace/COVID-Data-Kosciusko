...
#More Hospital Data
url = "https://healthdata.gov/sites/default/files/reported_hospital_capacity_admissions_facility_level_weekly_average_timeseries_20201215.csv"
...
```{r, eval = FALSE, echo=FALSE, fig.width=12, fig.height=14, warning=FALSE, message=FALSE}
#Compute the Index for the map coloring
Ind_trans <- Indices %>%
  select(PRIM_LONG_DEC, PRIM_LAT_DEC, key_numeric, COUNTY_NAME.x,
         combined, Case_per, POSITIVE_TEST_RATE_MOVING_AVG) %>%
