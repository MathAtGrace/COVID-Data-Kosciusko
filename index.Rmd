...
#US_counties <- subset(covid19.data.ALLcases, Country_Region == "US")
IN_counties <- subset(US_counties,
                      administrative_area_level_2 == "Indiana")

#US_counties$deaths <- US_counties$Deaths
#US_counties$confirmed <- US_counties$Confirmed

#IN_counties <- subset(US_counties,                       Province_State == "Indiana")
IN_counties$county <- as.factor(IN_counties$administrative_area_level_3)
#IN_counties$county <- as.factor(IN_counties$Admin2)
...
ggplot(Indiana, aes(x = date, y = hosp_per)) + 
  ...
  geom_vline(xintercept = as.Date("2020-07-01"))  +   geom_vline(xintercept = as.Date("2020-08-01")) + geom_vline(xintercept = as.Date("2020-09-01"))
```
