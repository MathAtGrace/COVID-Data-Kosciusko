...
rmarkdown::render('Grace_internal.Rmd',
                  output_file = 'G:/Shared drives/Dashboard - COVID-19/Grace_internal.pdf')
...
yest <- Sys.Date() - 3 #Weird stuff going on with updating of data
