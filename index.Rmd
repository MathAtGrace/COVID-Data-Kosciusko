...
author: "Compiled by Dr. Ryan Johnson using data from @COVID19, @WorldBank, @Oxford, @JohnHopkins"
...
USc_Indices$combined <- (USc_Indices$confirmed_index^2 + USc_Indices$death_index^2)^(1/4)
