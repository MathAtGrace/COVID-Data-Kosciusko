...
```{r vacs-state, fig.width=12, fig.height=14, warning=FALSE, message=FALSE, echo = FALSE}
ggplot(In_zip) +
...
The regio below extends from Plymouth (46563) in the West to Columbia City (46725) in the East.

```{r vacs-zips, fig.width=12, fig.height=12, warning=FALSE, message=FALSE, echo = FALSE}
In_zip %>%
